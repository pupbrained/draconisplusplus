  ...
  namespace parsing {
    ...
    struct Parser<R, W, rfl::Variant<FieldTypes...>, ProcessorsType> {
      ...
      read(const R& _r, const InputVarType& _var) noexcept {
        ...
        return Parser<R, W, std::variant<FieldTypes...>, ProcessorsType>::read(
                   _r, _var
        )
      ...
      static void write(
          const W&                           _w,
          const rfl::Variant<FieldTypes...>& _variant,
          const P&                           _parent
      ) noexcept {
      ...
      static schema::Type to_schema(
        ...
        return Parser<R, W, std::variant<FieldTypes...>, ProcessorsType>::
