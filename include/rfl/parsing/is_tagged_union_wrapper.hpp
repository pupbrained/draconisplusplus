...
namespace rfl {
  namespace parsing {
    ...
    class is_tagged_union_wrapper<TaggedUnionWrapperNoFields<T, TagType, _discriminator>>
      : public std::true_type {};

    template <class T, class TagType, internal::StringLiteral _discriminator>
    class is_tagged_union_wrapper<TaggedUnionWrapperWithFields<T, TagType, _discriminator>>
      : public std::true_type {};
