  ...
  namespace parsing {
    ...
    struct Parser<R, W, internal::Array<T>, ProcessorsType> {
     public:
      ...
      static Result<internal::Array<T>> read(const R& _r, const InputVarType& _var) noexcept {
        return Parser<R, W, StdArray, ProcessorsType>::read(_r, _var);
      }

      template <class P>
      static void write(const W& _w, const internal::Array<T>& _arr, const P& _parent) noexcept {
