...
namespace rfl {
  namespace parsing {
    ...
    template <class ProcessorsType, class... FieldTypes>
      requires AreReaderAndWriter<msgpack::Reader, msgpack::Writer, NamedTuple<FieldTypes...>>
    struct Parser<msgpack::Reader, msgpack::Writer, NamedTuple<FieldTypes...>, ProcessorsType>
    ...
    struct Parser<msgpack::Reader, msgpack::Writer, std::tuple<Ts...>, ProcessorsType>
      : public TupleParser<
          msgpack::Reader,
          msgpack::Writer,
          /*_ignore_empty_containers=*/false,
