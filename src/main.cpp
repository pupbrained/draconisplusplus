...
#ifdef DRAC_AUTOGENERATED_CONFIG
  warn_log("Using auto-generated config. Please update config.hpp to your liking and remove `#define DRAC_AUTOGENERATED_CONFIG` to disable this warning.");
#endif
